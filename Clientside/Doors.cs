...
namespace Clientside {
    class Doors : Script {
        ...
        public Doors() {
            //Chat.Output("Loaded Clientside.Doors");
            ...
            //var doorMarker1 = new Blip(411, new Vector3(981.7533f, -102.7987f, 74.8487f), "Clubhouse", 0.5f);
            //var doorMarker2 = new Blip(411, new Vector3(-711.545f, -915.54f, 19.216f), "Supermarket", 0.5f);
            //var doorMarker3 = new Blip(411, new Vector3(-59.893f, -1092.952f, 26.8836f), "Motorsport", 0.5f);
            //var doorMarker4 = new Blip(411, new Vector3(435.131f, -981.9197f, 30.689f), "Police", 0.5f);
